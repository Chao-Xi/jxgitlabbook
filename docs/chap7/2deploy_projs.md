...
![Alt Image Text](../images/chap7_2_9.png "Body image")

![Alt Image Text](../images/chap7_2_10.png "Body image")
...
![Alt Image Text](../images/chap7_2_11.png "Body image")

![Alt Image Text](../images/chap7_2_12.png "Body image")


FAQ

由于我们配置了`gradle.user.home`缓存到持久化存储中，所以这个缓存目录要有权限才行。否则会出现以下错误。
