...
```
wget https://mirrors.tuna.tsinghua.edu.cn/gitlab-ce/yum/el7/gitlab-ce-15.1.1-ce.0.el7.x86_64.rpm
...
```
mkdir -p ~/data/gitlab/conf ~/data/gitlab/logs ~/data/gitlab/data
